...
public interface FriendsFollowersResources
{
	...
	/**
	 * Returns an array of numeric IDs for every user the authenticating user is following. <br>
	 * This method calls http://api.twitter.com/1.1/friends/ids.json
	 * 
	 * @param cursor
	 *           Causes the list of connections to be broken into pages of no more than 5000 IDs at a time. The number of
	 *           IDs returned is not guaranteed to be 5000 as suspended users are filterd out after connections are
	 *           queried. <br/>
	 *           To begin paging provide a value of -1 as the cursor. The response from the API will include a
	 ...
	 * 
	 * @param screenName
	 *           Specifies the screen name of the user for whom to return the friends list.
	 * @param cursor
	 *           Causes the list of connections to be broken into pages of no more than 5000 IDs at a time. The number of
	 *           IDs returned is not guaranteed to be 5000 as suspended users are filterd out after connections are
	 *           queried. <br/>
	...
	/**
	 * Returns an array of numeric IDs for every user the specified user is followed by. <br>
	...
	IDs getFollowersIDs(long userId, long cursor, long count) throws TwitterException;
	...
	/**
	 * Returns the relationship of the authenticating user to the specified users. <br>
	 ...
	 * @throws TwitterException
	 *            when Twitter service or network is unavailable
	 * @see <a href="http://groups.google.com/group/twitter-api-announce/msg/34909da7c399169e">#newtwitter and the API -
	 *      Twitter API Announcements | Google Group</a>
	...
	/**
	 * Returns an array of numeric IDs for every user who has a pending request to follow the authenticating user. <br>
	 * This method calls http://api.twitter.com/1.1/friendships/incoming.json
	 * 
	 * @param cursor
	 *           Breaks the results into pages. A single page contains 5000 identifiers. Provide a value of -1 to begin
	 *           paging.
	 * @return an array of numeric IDs for every user who has a pending request to follow the authenticating user.
	 * @throws TwitterException
	 *            when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friendships/incoming">GET friendships/incoming | Twitter
	 *      Developers</a>
	 ...
	 *           Breaks the results into pages. A single page contains 5000 identifiers. Provide a value of -1 to begin
	 *           paging.
	 * @return an array of numeric IDs for every protected user for whom the authenticating user has a pending follow
	 *         request.
	 * @throws TwitterException
	 *            when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friendships/outgoing">GET friendships/outgoing | Twitter
	 *      Developers</a>
	 * @since Twitter4J 2.1.2
	 */
	 ...
	 * Returns the befriended user in the requested format when successful. Returns a string describing the failure
	 * condition when unsuccessful. If you are already friends with the user an HTTP 403 will be returned. <br>
	 ...
	 * @throws TwitterException
	 *            when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/post/friendships/create">POST friendships/create | Twitter
	 *      Developers</a>
	 ...
	 * condition when unsuccessful. <br>
	 ...
	 * @throws TwitterException
	 *            when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/post/friendships/destroy">POST friendships/destroy | Twitter
	 *      Developers</a>
	 * @since Twitter4J 2.1.0
	 */
	...
	/**
	 * Allows you to enable or disable retweets and device notifications from the specified user. <br>
	 * This method has not been finalized and the interface is subject to change in incompatible ways. <br>
	 * This method calls http://api.twitter.com/1.1/friendships/update.json
	 * 
	 * @param userId
	 *           user id to update
	 * @param enableDeviceNotification
	 *           set true to enable device notification
	 * @param retweets
	 ...
	 * @throws TwitterException
	 *            when Twitter service or network is unavailable
	 * @see <a href="https://dev.twitter.com/docs/api/1.1/get/friendships/show">GET friendships/show | Twitter
	 *      Developers</a>
	 * @since Twitter4J 2.1.0
	 */
	 ...
	 *           the screen name of the source user
	 ...
	 * their "friends").<br>
	 * At this time, results are ordered with the most recent following first ��� however, this ordering is subject to
	 * unannounced change and eventual consistency issues. Results are given in groups of 20 users and multiple "pages"
	 * of results can be navigated through using the next_cursor value in subsequent requests. See <a
	 * href="https://dev.twitter.com/docs/misc/cursoring">Using cursors to navigate collections</a> for more information. <br>
	...
	PagableResponseList<User> getFriendsList(long userId, long cursor, long count) throws TwitterException;
	...
	PagableResponseList<User> getFollowersList(long userId, long cursor, long count) throws TwitterException;
	...
	IDs getFriendsIDs(String screenName, long cursor, long count) throws TwitterException;
